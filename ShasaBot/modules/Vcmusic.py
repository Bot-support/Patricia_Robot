...
__help__ = """
 ...
 PATRICIA_VCPLAYER plays music in your group's voice chat
 
 Assistant name >> ꧁ @PATRICIAXMUSIC ꧂
 
⚙️Setting up 
1) Make bot admin
2) Start a voice chat
3) Try `/play [song name]` for the first time by an admin
*) If userbot joined enjoy music, If not add @PATRICIAXMUSIC to your group and retry
  Commands
...
=>> More tools 📲
  ...
  /userbotjoin: Invite @PATRICIAXMUSIC Userbot to your chat
